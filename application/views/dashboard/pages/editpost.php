	...
	<div class="row">
		<div class="col-xl-8 col-sm-12 offset-md-2">
			...
			<div class="form-group">
				...
				<textarea id="textarea-newpost" name="content">
					<?php echo $p->post_desc; ?>
				</textarea>
			...
			<div class="form-group" id="currentFeaturedImage">
				...
				<div class="edit-image-wrap">
					<img src="<?php echo base_url();?>uploads/<?php echo $p->post_img; ?>" style="width: 200px;">
				</div>
				<div class="remove-image">
					<a href="#">
						<i class="fa fa-window-close" aria-hidden="true"></i> Remove</a>
				</div>
			...
			<div class="form-group" id="updateFeaturedImage" style="display: none">
				<label for="uploadImage">
					<b>Upload Featured Image</b>
				</label>
				<input type='file' class="form-control" name='newfeaturedimg' id="uploadImage" accept=".gif,.jpg,.png,.jpeg" />
			</div>
			<div class="form-group">
				<select class="form-control" name="approved">
                    <option value="1"<?php echo $p->post_approved == true ? ' selected="selected"' : '';?>>Publish</option>
                    <option value="0"<?php echo $p->post_approved == false ? ' selected="selected"' : '';?>>Draft</option>
				</select>
			</div>
